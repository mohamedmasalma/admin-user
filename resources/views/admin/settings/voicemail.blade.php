...
@section('setting_voicemail', 'm-menu__item--active')
...
<form  method="POST" action="{{ route('save.rvm') }}" enctype="multipart/form-data" >
@csrf
...
<div class="col-2" ><b>Sender ID :</b> </div>
 <div  class="col-5" ><input type="text" id="sender_id" value="{{$sender}}"  class="form-control" name='sender_id' > </div> 
...
<div class="col-2" ><b>Forward Returned Calls to :</b> </div>
 <div  class="col-4 offset-0" ><input type="text" id="retuncalls" value="{{$reply}}" class="form-control" name='r_calls' > </div> 
