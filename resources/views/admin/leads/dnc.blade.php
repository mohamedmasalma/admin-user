...
<form method="post" id="dnc{{$dnc['id']}}" action="{{route('admin.delete.dnc',["id"=>$dnc['id']])}}" style="display: none;"> @csrf</form>
</td>
</tr>
@endforeach
</table>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Delete DNC</h5>
