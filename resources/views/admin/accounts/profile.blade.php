...
<input type="text" name="f_name" class="form-control" readonly placeholder="@if(Auth::user()->profile){{Auth::user()->name}}@endif">
</div>
...
value="@if(Auth::user()->profile){{Auth::user()->profile->l_name}}@endif">
</div>
