...
<div class="myowndiv">
<form  method="POST" action="{{ route('user.store.camp') }}" enctype="multipart/form-data" >
...
<input type="text" name="camp_start" class="form-control timepicker">
...
<select class="form-control" name="time_zone" id="timezone1">  
...
<select class="form-control" id="hours_Rvm">   
<option value="" name='voice_rate' selected="select">Select</option>   
