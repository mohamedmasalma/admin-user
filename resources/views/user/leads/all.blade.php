...
<form method="post" id="lead{{$lead['id']}}" action="{{route('user.delete.lead',["id"=>$lead['id']])}}" style="display: none;"> @csrf</form>
</td>
</tr>
@endforeach
</table>
...
<form  method="POST" action="{{ route('user.update.lead') }}" enctype="multipart/form-data" >
...
$('#deleteLeadBody').html('Are you sure you want to delete this lead??')    
