...
<a href="{{route('user.download.csv')}}">Click here​  </a> to download the CSV template</p>

<div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{route('user.parse.import')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
