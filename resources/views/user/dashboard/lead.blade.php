...
<a href="{{route('user.lead.all')}}" class="text-primary">{{$count['all']}}</a>
</figure>
</div>
...
<a href="{{route('user.lead.dnc')}}" class="text-primary">{{$count['dnc']}}</a>
</figure>
</div>
...
<a href="{{route('user.lead.sold')}}" class="text-primary">{{$count['notdnc']}}</a>
</figure>
</div>
