...
<a href="{{route('user.all.camp')}}" class="text-primary">{{$count['all']}}</a>
</figure>
</div>
...
<a href="{{route('user.sche.camp')}}" class="text-primary">{{$count['sche']}}</a>
</figure>
</div>
...
<a href="{{route('user.completed.camp')}}" class="text-primary">{{$count['completed']}}</a>
</figure>
</div>
