...
<div class="m-stack__item m-stack__item--middle m-brand__logo"> <a href="{{route('user.dash.camp')}}" class="m-brand__logo-wrapper"> <img alt="" 
...
<li class="m-menu__item @yield('dashboard_camp') "  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.dash.camp')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-dashboard"></i><span class="m-menu__link-text">Campaigns Dashboard</span></a></li>

<li class="m-menu__item @yield('dashboard_lead')"  aria-haspopup="true"><a  href="{{route('user.dash.lead')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-profile-1"></i><span class="m-menu__link-text">Leads Dashboard</span></a></li>
...
<li class="m-menu__item  @yield('campaign') m-menu__item--submenu m-menu__item--tabs" m-menu-submenu-toggle="tab" aria-haspopup="true"><a  href="{{route('user.all.camp')}}" class="m-menu__link " title="Non functional dummy link"><span class="m-menu__link-text">Campaigns</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
<ul class="m-menu__subnav">
	<li class="m-menu__item @yield('campaign_all') "  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.all.camp')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-signs"></i><span class="m-menu__link-text">All</span></a></li>
<li class="m-menu__item @yield('campaign_create') "  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.create.camp')}}" class="m-menu__link "><i class="flaticon-paper-plane"></i><span class="m-menu__link-text">Create Campaign </span></a></li>
<li class="m-menu__item @yield('campaign_sche')"  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.sche.camp')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-calendar-with-a-clock-time-tools"></i><span class="m-menu__link-text">Scheduled</span></a></li>
<li class="m-menu__item @yield('campaign_completed') "  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.completed.camp')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-interface-7"></i><span class="m-menu__link-text">Completed</span></a></li>
...
<li class="m-menu__item   @yield('lead')  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true"><a  href="{{route('user.lead.all')}}" class="m-menu__link " title="Non functional dummy link"><span class="m-menu__link-text">Leads</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
<ul class="m-menu__subnav">
<li class="m-menu__item  @yield('lead_all')"  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.lead.all')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">All</span></a></li>
<li class="m-menu__item  @yield('lead_add')"  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.lead.add')}}" class="m-menu__link " ><i class="flaticon-user-add"></i><span class="m-menu__link-text">Add</span></a></li>
<li class="m-menu__item   @yield('lead_dnc')"  aria-haspopup="true"><a  href="{{route('user.lead.dnc')}}" class="m-menu__link " ><i class="m-menu__link-icon flaticon-circle"></i><span class="m-menu__link-text">DNC</span></a></li>

<li class="m-menu__item   @yield('lead_sold')"  aria-haspopup="true"><a  href="{{route('user.lead.sold')}}" class="m-menu__link " ><i class="m-menu__link-icon fas fa-dollar-sign"></i>
<span class="m-menu__link-text">SOLD</span></a></li>

<li class="m-menu__item  @yield('lead_import')"  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.upload.view')}}" class="m-menu__link " ><i class="m-menu__link-icon flaticon-upload-1"></i><span class="m-menu__link-text">Import</span></a></li>
...
<li class="m-menu__item @yield('template') m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true"><a  href="{{route('user.template.sms')}}" class="m-menu__link " title="Non functional dummy link"><span class="m-menu__link-text">Templates</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
<ul class="m-menu__subnav">
<li class="m-menu__item @yield('template_sms')"  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.template.sms')}}" class="m-menu__link "><i class="flaticon-comment"></i><span class="m-menu__link-text">SMS</span></a></li>
<li class="m-menu__item @yield('template_email') "  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.template.email')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-email"></i><span class="m-menu__link-text">E-Mail</span></a></li>
<li class="m-menu__item @yield('template_voicemail')"  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.template.voicemail')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-music"></i><span class="m-menu__link-text">Ringless Voicemail</span></a></li>

</ul>
</div>
</li>
<li class="m-menu__item @yield('setting')  m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true"><a  href="{{route('user.setting.sms')}}" class="m-menu__link " title="Non functional dummy link"><span class="m-menu__link-text">Settings</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
<ul class="m-menu__subnav">
<li class="m-menu__item @yield('sms_setting')  "  m-menu-link-redirect="1" aria-haspopup="true"><a  href=" {{route('user.setting.sms')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-comment"></i><span class="m-menu__link-text">SMS Settings</span></a></li>
<li class="m-menu__item @yield('email_setting')  "  m-menu-link-redirect="1" aria-haspopup="true"><a  href=" {{route('user.setting.email')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-email"></i><span class="m-menu__link-text">E-mail Settings</span></a></li>
<li class="m-menu__item @yield('voice_setting')  "  m-menu-link-redirect="1" aria-haspopup="true"><a  href=" {{route('user.setting.voicemail')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-music"></i><span class="m-menu__link-text">Ringless Voicemail Settings</span></a></li>

</ul>
</div>
</li>
<li class="m-menu__item   @yield('account') m-menu__item--submenu m-menu__item--tabs"  m-menu-submenu-toggle="tab" aria-haspopup="true"><a  href="{{route('user.accounts.profile')}}" class="m-menu__link " title="Non functional dummy link"><span class="m-menu__link-text">Account </span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs"><span class="m-menu__arrow m-menu__arrow--adjust"></span>
<ul class="m-menu__subnav">
<li class="m-menu__item  @yield('account_profile') "  m-menu-link-redirect="1" aria-haspopup="true"><a  href="{{route('user.accounts.profile')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-profile"></i><span class="m-menu__link-text">Profile
</span></a></li>
<li class="m-menu__item @yield('account_subscription') "  aria-haspopup="true"><a  href="{{route('user.accounts.subscription')}}" class="m-menu__link "><i class="m-menu__link-icon flaticon-piggy-bank"></i><span class="m-menu__link-text">Subscription</span></a></span></a></li>
